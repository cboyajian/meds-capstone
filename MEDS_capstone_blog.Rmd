...
-   You will hear this plenty at Bren (if you haven't already), but **networking** is a crucial part of your graduate school experience. This includes networking with your cohort! Your cohort will be some of your strongest connections after you graduate, and working on a capstone proposal with one or some of them is a great opportunity to build those connections. Beyond your cohort, working on a proposal with a client gives you several excellent opportunities to network with potential employers.
...
#### Client Inspiration (WORKING ON DATA VIZ FOR THIS WILL ADD LATER)

Don't know where to start or what client you want to work with? Check out these organizations! Here are all the clients and faculty advisors Bren students have worked with.
